...
updated_at: 2026-05-19T18:20:12Z
---
...
- [x] Fix review finding: publish queued snapshot status before trigger
...
Review finding fix: BlueprintTuiMetrics::request_snapshot now stores SnapshotStatus::Queued before publishing the snapshot trigger, with focused snapshot tests covering the status ordering.
