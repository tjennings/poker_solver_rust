...
updated_at: 2026-07-28T18:14:47Z
...
- Added typed lazy MP betting and exact-solve snapshots with raw seat-order reaches and raw TreeAction metadata.
- Wired UniversalMpLazy flop Exact solves through the existing rooted range-solver builder and solve overlay/cache anchoring.
- Added asymmetric SB raise, BB reraise, SB call regression coverage.

Residual limitation: UniversalMpLazy Exact support remains limited to two-player flop decision spots; turn and river navigation/solving remain unsupported.
