...
updated_at: 2026-07-31T00:22:47Z
---

Synchronize local main with origin/main after the remote rejected the initial push, preserve remote commits, and successfully push the merged main branch.\n\n- [ ] Fetch and inspect origin/main divergence.\n- [ ] Integrate remote commits without discarding work.\n- [ ] Push main successfully.\n- [ ] Verify local and remote refs match.
