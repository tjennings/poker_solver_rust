...
updated_at: 2026-03-11T15:42:00Z
---
...
- [ ] Stream 1: Delete tests + benchmarks (Task 1)
- [ ] Stream 2: Delete sample configs (Task 2)
- [ ] Stream 3: Trainer cleanup - delete support files + remove old CLI commands (Tasks 3-4)
- [ ] Stream 4: Core cleanup - delete preflop/ + blueprint/, refactor simulation.rs + info_key.rs (Tasks 5-8)
- [ ] Stream 5: Tauri cleanup - refactor exploration.rs + simulation.rs + lib.rs (Tasks 9-10)
- [ ] Stream 6: Documentation updates (Tasks 13-14)

## Post-merge

- [ ] Clean up Cargo dependencies (Task 11)
- [ ] Run full test suite + clippy (Task 12)
