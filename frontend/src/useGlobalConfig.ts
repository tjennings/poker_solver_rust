...
const DEFAULT_CONFIG: GlobalConfig = { blueprint_dir: '', target_exploitability: 3.0, solve_iterations: 200, backend_url: '', matrix_snapshot_interval: 10, range_clamp_threshold: 0.0, flop_boundary_mode: 'exact', turn_boundary_mode: 'exact', river_boundary_mode: 'exact', flop_model_path: '', turn_model_path: '', river_model_path: '', turn_model_kind: 'direct', river_model_kind: 'river_enumerated_turn', trace_boundaries: '', trace_iters: 'last', enable_safe_resolving: false };
